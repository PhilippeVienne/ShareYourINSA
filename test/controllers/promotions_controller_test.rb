...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { end_date: @promotion.end_date, id_department: @promotion.id_department, start_date: @promotion.start_date }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { end_date: @promotion.end_date, id_department: @promotion.id_department, start_date: @promotion.start_date }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
